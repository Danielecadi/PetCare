...
<template>
	<AppLayout title="Modifica animale">
		<template #header>
			<h2 class="text-lg font-semibold leading-6 text-gray-900">
				Modifica animale: {{ pet.name }}
			</h2>
		</template>
			...
			<form @submit.prevent="editPet" enctype="multipart/form-data" class="space-y-5">
				<div class="grid grid-cols-12 gap-5">
					<div class="col-span-6">
						<label for="name" class="mb-2 block text-sm font-medium text-gray-500">Nome</label>
					...
					<div class="col-span-6">
						<label for="client_id" class="mb-2 block text-sm font-medium text-gray-500">Cliente</label>
						<VueMultiselect v-model="selectedUser"
							:class="{ 'error': errors.client_id }"
							:options="matchingUsers" :multiple="false" :clear-on-select="true" select-label="Premi Invio per selezionare" placeholder="Digita per cercare" label="name"
					...
					<div class="col-span-12 sm:col-span-6">
						<label for="species" class="mb-2 block text-sm font-medium text-gray-500">Specie</label>
						<VueMultiselect v-model="selectedSpecies"
							:class="{ 'error': errors.species_id }"
							:options="matchingSpecies" :multiple="false" :clear-on-select="true" select-label="Premi Invio per selezionare" placeholder="Digita per cercare"
					...
					<div class="col-span-8 sm:col-span-10">
						<label for="gender" class="mb-2 block text-sm font-medium text-gray-500">Sesso</label>
					...
					<div class="col-span-4 sm:col-span-2">
						<label for="age" class="mb-2 block text-sm font-medium text-gray-500">Età</label>
					...
					<div class="col-span-12">
						<div class="mx-auto max-w-full">
							<label for="photo" class="mb-2 block text-sm font-medium text-gray-500">Foto dell'animale</label>
							<label @dragover.prevent @drop.prevent="handleFileDrop"
								...
								<div class="space-y-1 text-center">
									<div class="mx-auto inline-flex h-20 w-20 items-center justify-center rounded-full bg-gray-100">
										<img v-if="editForm.photo && editForm.photo.url" :src="editForm.photo.url" alt="Foto dell'animale" class="h-20 w-20 rounded-full" />
										<div v-else>
